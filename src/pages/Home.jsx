...
const Home = () => {
    ...
    useEffect(() => {
        // Uncomment to retrieve all users from Firebase
        // const getAllUsers = async () => {
        //     const collectionReference = collection(db, "users");
        //     const userDocs = await getDocs(collectionReference);
        ...
        // Uncomment to add a document in a collection
        // const addDocument = async () => {
        //     const documentReference = doc(db, "users", "saiy");
        //     try {
        ...
        //         addDoc(collectionReference , product).then(res=>{
        //             console.log(res);
        //         })
        //     })
        // }
